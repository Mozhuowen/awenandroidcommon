...
/**
 * 重构 com.blunderer.materialdesignlibrary.activities.NavigationDrawerActivity
 */
public abstract class NavigationDrawerActivity extends AAActivity
...
//        }
    ...
    private void defineDrawerLayout() {
        ...
        mDrawerToggle = new ActionBarDrawerToggle(
            ...
            public void onDrawerClosed(View view) {
                ...
                if (onDrawerCloseListener != null) onDrawerCloseListener.onClose(mCurrentItemPosition);
            }
            ...
            public void onDrawerOpened(View drawerView) {
                ...
                mTopListView.removeHeaderView(mAccountsLayout);
                showAccountsLayout();
    ...
    private void initFragment(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            pagePosition = savedInstanceState.getInt("page_position",0);
        ...
        selectPage(fragmentPosition, pagePosition, savedInstanceState);
    }
    ...
    private void onListItemTopClick(AdapterView<?> adapterView, View view, int i) {
        final ListItem item = (ListItem) adapterView.getAdapter().getItem(i);
...
//            }, 250);
            ...
            //testcode closenavigationDrawer
//            closeNavigationDrawer();
...
//                mAccountsLayout = new NavigationDrawerAccountsLayoutSmall(getApplicationContext());
            ...
            //点击TOPVIEW触发自定义方法
            mAccountsLayout.setTopViewHasOtherEvent(true);
            mAccountsLayout.setOnClickAccountsLayoutDelegate(new ANavigationDrawerAccountsLayout.OnClickAccountsLayout() {
                @Override
                public void onClick() {
                    onDrawerTopViewClick();
                }
            });
    ...
    protected abstract void onDrawerTopViewClick();
    protected abstract boolean shouldCheckLoginState();
    protected abstract void checkUpdate();
    protected abstract void doExtraTask();
    ...
    public void selectPage(int currenFragmentPosition,final int currentPage,Bundle savedInstanceState) {
        if ( !(((NavigationDrawerListItemTopFragment) mNavigationDrawerItemsTop.get(currenFragmentPosition)).getFragment() instanceof ViewPagerWithTabsFragment))
        {
            return;
        }

        final ViewPagerWithTabsFragment fragment = (ViewPagerWithTabsFragment) ((NavigationDrawerListItemTopFragment) mNavigationDrawerItemsTop.get(currenFragmentPosition)).getFragment();
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                fragment.selectPage(currentPage);
            }
        },300);

    }

    public static abstract class OnDrawerCloseListener
    {
        public abstract void onClose(int currSelectItem);
    }
