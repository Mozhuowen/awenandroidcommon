...
public class StickHeaderViewPager extends StickHeaderLayout implements ScrollHolder, ViewPager.OnPageChangeListener {
    ...
    protected HeaderTranslationDelegate headerTranslationDelegate;

    private int mStickViewHeight;
    private int mStickHeaderHeight;
    private int mMinHeaderTranslation;
    public int mStickHeaderAddHeight = 0;
...
//            Log.e("updateChildViewHight","mStickHeaderHeight->"+mStickHeaderHeight+" mStickViewHeight->"+mStickViewHeight);
...
//        Log.e("scrollHeader", "scrollY->" + scrollY + "mMinHeaderTranslation->" + mMinHeaderTranslation);
        /**增加 mStickHeaderAddHeight  */
        float translationY = Math.max(-scrollY, mMinHeaderTranslation + mStickHeaderAddHeight);
        mStickheader.setTranslationY(translationY);
        if (this.headerTranslationDelegate != null)
            this.headerTranslationDelegate.scrollHeader(translationY);
    }
    ...
    public void setHeaderTranslationDelegate(HeaderTranslationDelegate headerTranslationDelegate) {
        this.headerTranslationDelegate = headerTranslationDelegate;
    }
    ...
    public static interface HeaderTranslationDelegate
    {
        void scrollHeader(float translationY);
    }
}
