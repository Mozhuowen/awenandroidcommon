...
/**
 * 重构 com.blunderer.materialdesignlibrary.views.ANavigationDrawerAccountLayout
 */
public abstract class ANavigationDrawerAccountsLayout extends LinearLayout {
    ...
    public boolean isTopViewHasOtherEvent = false;
    protected OnClickAccountsLayout onClickAccountsLayoutDelegate;
    ...
    private void initAccountsLayout() {
        ...
        mMainLayout.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isTopViewHasOtherEvent)
                    switchAccountsMenu();
                else
                    onClickAccountsLayout();
            }

        });
    }

    public void setTopViewHasOtherEvent(boolean has) {
        this.isTopViewHasOtherEvent = has;
    }

    protected abstract void onClickAccountsLayout();
    ...
    public static abstract class OnClickAccountsLayout
    {
        public abstract void onClick();
    }


    public void setOnClickAccountsLayoutDelegate(OnClickAccountsLayout delegate) {
        this.onClickAccountsLayoutDelegate = delegate;
    }
